...
Containerum docs is a documentation project for [Containerum Web UI](https://github.com/containerum/containerum). It contains  guides on installing and configuring Containerum Web UI, manuals, CI/CD instructions, etc.
